...
class CustomTableViz(BaseViz):
    ...
    viz_type = 'custom_table'
    verbose_name = _('Custom Table View')
    credits = 'a <a href="https://github.com/airbnb/superset">Superset</a> original'
    is_timeseries = False
    enforce_numerical_metrics = False
...
class CustomReportImageViz(BaseViz):

    """A basic html table that is sortable and searchable"""

    viz_type = 'custom_report_image'
    verbose_name = _('Custom Report View')
    credits = 'a <a href="https://github.com/airbnb/superset">Superset</a> original'
    is_timeseries = False
    enforce_numerical_metrics = False
    ...
    def query_obj(self):
        d = super(CustomReportImageViz, self).query_obj()
        fd = self.form_data
...
class CustomSearchViz(BaseViz):

    viz_type = 'custom_search'
    verbose_name = _('CustomSearch')
    is_timeseries = False
